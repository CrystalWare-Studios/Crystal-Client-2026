...
Crystal Client is source-available and free for personal use. Redistribution, rebranding, and commercial use are not permitted without written permission. See [`LICENSE`](LICENSE).
